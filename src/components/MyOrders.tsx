...
const MyOrders = () => {
  ...
  const booklist = [
    { image: bookimage, title: 'Dont Make me Think', author: 'Steve Krug', sellingprice: 1500, mrp: 2000, orderDate: "May 21" },
    { image: bookimage, title: 'Dont Make me Think', author: 'Steve Krug', sellingprice: 1500, mrp: 2000, orderDate: "May 21" },
    { image: bookimage, title: 'Dont Make me Think', author: 'Steve Krug', sellingprice: 1500, mrp: 2000, orderDate: "May 21" },
    { image: bookimage, title: 'Dont Make me Think', author: 'Steve Krug', sellingprice: 1500, mrp: 2000, orderDate: "May 21" },
  ]
          ...
          {booklist.map((book, index) => (
            <div className="border border-[#E4E4E4] !p-[40px] flex justify-between ">
              ...
              <div className="delete wala right cotainer">
                <p className="text-[15px] font-bold ">Order Placed on {book.orderDate}</p>
