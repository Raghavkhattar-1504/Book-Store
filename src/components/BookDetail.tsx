...
function BookDetail() {
  ...
  return (
    <>
    <Navbar />
    <div className=' w-[100%] flex flex-col items-center !my-[25px]'>

      <nav aria-label="breadcrumb" className="w-[68%] h-[100px] flex items-center max-md:w-[90%]">
        <ol className="flex w-full flex-wrap items-center rounded-md  px-4 py-2">
          <li className="flex gap-1 cursor-pointer items-center text-[20px] text-slate-500 transition-colors duration-300 hover:text-slate-800">
            <a href="/home">Home</a>
            <span className="pointer-events-none mx-2 text-slate-800 !mr-1">
              /
            </span>
          </li>
          <li className="flex gap-1 text-black cursor-pointer items-center text-[20px] transition-colors duration-300 hover:text-slate-800">
      ...
      <div className='w-[68%] flex justify-between max-md:w-[90%] max-md:flex-col max-md:justify-center max-md:items-center max-sm:flex-col max-sm:justify-center max-sm:items-center'>
        <div className='w-[35%] h-[500px] flex max-md:w-[45%] max-sm:w-[90%]'>
          <div className='w-[15%] h-[200px]'>
            <div className='h-[75px] w-[100%] border border-black flex justify-center items-center'>
              <img src={bookImage1} className='h-[62px] !p-[2px]' />
            </div>
            <div className='h-[75px] w-[100%] border border-[#ADADAD] flex justify-center items-center'>
        ...
        <div className='w-[62%] max-md:w-[85%]'>
          <div className=' w-[100%] flex flex-col gap-[5px] !mb-[15px]'>
            ...
            <div className='flex gap-x-2'>
              ...
              <p className='text-[13px] text-[#ADADAD] !mt-[6px]'>(20)</p>
            </div>
          ...
          <div className='w-[100%] !mt-[35px] p-4 rounded-lg'>
            ...
            <div className="!mt-4 !ml-3 flex flex-col gap-1 ">
              ...
              <div className='bg-[#F9F9F9]'>
                <textarea
                  className="w-full !mt-1 !mb-5 !p-2 outline-none h-[60%] resize-none rounded-md"
                  rows={4}
                  placeholder="Write Your Review..."
                  value={review}
                  onChange={(e) => setReview(e.target.value)}
                />
                <div className='flex justify-end !pr-2 h-[20%] bg-[white] !pt-5'>
                  <button className="bg-[#3371B5] text-white w-[75px] h-[24%] rounded-[3px] hover:bg-[#2A5C94] transition !px-[10px] !py-[5px]">
                    Submit
                  </button>
                </div>
              </div>
